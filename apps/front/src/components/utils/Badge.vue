...
<template>
  ...
  >
    <div v-if="element === 'dark-light'" class="badge__wrapper">
      <div class="badge__container">
        ...
        >
          <path
            d="M7.5 0.705L6.795 0L4 2.795L1.205 0L0.5 0.705L3.295 3.5L0.5 6.295L1.205 7L4 4.205L6.795 7L7.5 6.295L4.705 3.5L7.5 0.705Z"
            fill="url(#paint0_linear_790_3407)"
          />
          <defs>
            <linearGradient
              id="paint0_linear_790_3407"
              x1="16"
              y1="3.5"
              x2="-71"
              y2="3.5"
    ...
    <Tooltip
      v-show="monstersImages && tooltipIsDisplayed"
      v-if="!canBeDeleted"
      :imgs="monstersImages"
    />
  </li>
