...
<template>
  <div class="more" v-if="actionsToDisplay.length > 0">
    <button class="more__button" @click="isOpened = !isOpened">
      <svg
  ...
  <div class="more__trigger" @click="isOpened = false" v-show="isOpened"></div>
</template>
