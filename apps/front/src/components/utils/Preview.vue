    ...
    <div class="preview__head">
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="15" viewBox="0 0 18 15" fill="none">
          <path d="M1.7625 0L0 1.7625L5.725 7.5L0 13.2375L1.7625 15L9.2625 7.5L1.7625 0Z" fill="var(--text-grey)"/>
          <path d="M9.99932 0L8.23682 1.7625L13.9618 7.5L8.23682 13.2375L9.99932 15L17.4993 7.5L9.99932 0Z" fill="var(--text-grey)"/>
        </svg>
      </button>
      <More
        v-if="actions"
